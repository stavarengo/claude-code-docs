...
DALL·E 3 has been deprecated and removed from the API. We recommend [GPT-Image-2.5 Sunburst](/api/docs/models/gpt-image-2.5-sunburst) for current image generation and editing.
