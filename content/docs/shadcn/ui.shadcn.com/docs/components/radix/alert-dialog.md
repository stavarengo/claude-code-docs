...
For more information about the other components and their props, see the [Radix UI documentation](../../../../raw.githubusercontent.com/radix-ui/website/refs/heads/main/data/primitives/docs/components/alert-dialog.mdx#api-reference).
