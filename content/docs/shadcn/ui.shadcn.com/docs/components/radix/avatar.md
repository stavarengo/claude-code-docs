...
For more information about Radix UI Avatar props, see the [Radix UI documentation](../../../../raw.githubusercontent.com/radix-ui/website/refs/heads/main/data/primitives/docs/components/avatar.mdx#api-reference).
